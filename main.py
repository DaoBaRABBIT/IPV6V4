...
Button_ConnectionI6 = Button(c_bottom_top_main_window,text="连接",width=20,height=1,command=lambda: founction.tStartupC(IPV6ADDCONN.get(),IPV6ADDCONNP.get(),Button_ConnectionI6,Button_StopI6))
