...
Label(Listbox_Frame,text="连接信息").grid(row=0,column=2,sticky="w")
Listbox_conninfoIP = Listbox(Listbox_Frame,width=45,height=8)
...
Listbox_conninfo = Listbox(Listbox_Frame,width=10,height=8)
...
Button_ConnectionI6 = Button(c_bottom_top_main_window,text="连接",width=20,height=1,command=lambda: founction.StartupC(IPV6ADDCONN.get(),IPV6ADDCONNP.get(),Button_ConnectionI6,Button_StopI6))
